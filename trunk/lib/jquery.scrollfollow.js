...
( function( $ ) {
	...
	{ 
		...
		{		
			...
			if ( isActive )
			{
				...
				if ( options.relativeTo == 'top' )
				{
					...
					{
						/*console.log( 'Case 1: ' + ( -parentTop ) );
						console.log( 'Case 2: ' + ( pageScroll - iBoxOTop + iTop ) );
						console.log( 'Case 3: ' + ( parentHeight - boxHeight - padAdj ) )*/
		...
		var initialTop = parseInt( box.css( 'top' ) );
